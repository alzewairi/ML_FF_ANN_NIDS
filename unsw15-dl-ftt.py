...
def dl_rectifier_5():
    model_name = "dl_Rectifier_ftt_5percent"
    predictor_columns = ["proto", "service", "ct_state_ttl", "state", "dttl", "sttl", "swin", "trans_depth",
                         "dwin", "dmeansz", "djit", "dsport"]
    print model_name
    dl_modeling(model_id=model_name, predictor_columns=predictor_columns)


def dl_rectifier_10():
    model_name = "dl_Rectifier_ftt_10percent"
    predictor_columns = ["proto", "service", "ct_state_ttl", "state", "dttl", "sttl", "swin", "trans_depth",
                         "dwin", "dmeansz", "djit", "dsport", "ct_dst_sport_ltm", "ct_srv_dst", "sjit", "sloss"]
    print model_name
    dl_modeling(model_id=model_name, predictor_columns=predictor_columns)


def dl_rectifier_15():
    model_name = "dl_Rectifier_ftt_15percent"
    predictor_columns = ["proto", "service", "ct_state_ttl", "state", "dttl", "sttl", "swin", "trans_depth",
                         "dwin", "dmeansz", "djit", "dsport", "ct_dst_sport_ltm", "ct_srv_dst", "sjit", "sloss",
                         "ct_srv_src"]
    print model_name
...
def dl_rectifier_20():
    model_name = "dl_Rectifier_ftt_20percent"
    predictor_columns = ["proto", "service", "ct_state_ttl", "state", "dttl", "sttl", "swin", "trans_depth",
                         "dwin", "dmeansz", "djit", "dsport", "ct_dst_sport_ltm", "ct_srv_dst", "sjit", "sloss",
                         "ct_srv_src", "smeansz", "synack"]
    print model_name
    dl_modeling(model_id=model_name, predictor_columns=predictor_columns)


def dl_rectifier_full():
    model_name = "dl_Rectifier_ftt_full"
